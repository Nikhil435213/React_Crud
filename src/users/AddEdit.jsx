    ...
    useEffect(() => {
        if (!isAddMode) {
            ...
            userService.getById(id).then(user => {
                const fields = ['title', 'firstName', 'lastName', 'email', 'role','contact1','contact2'];
        ...
        <form onSubmit={handleSubmit(onSubmit)} onReset={reset}>
            ...
            <div className="form-row">
                <div className="form-group col-7">
                    ...
                    <input name="Contact No 1 : " type="text" ref={register} className={`form-control ${errors.contact1 ? 'is-invalid' : ''}`} />
                    <div className="invalid-feedback">{errors.contact1?.message}</div>
                </div>
                <div className="form-group col">
                    <label>Contact No 2 :</label>
                    <input name="Contact No 2 : "type='text' ref={register} className={`form-control ${errors.contact2 ? 'is-invalid' : ''}`}>
                    </input>
                    <div className="invalid-feedback">{errors.contact2?.message}</div>
                </div>
            </div>
            {!isAddMode &&
                <div>
